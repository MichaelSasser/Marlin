...
#define LCD_SHOW_E_TOTAL
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY <- just uncomment
   ...
   */
  //#define SD_ABORT_ON_ENDSTOP_HIT <- yes
  ...
  //#define BINARY_FILE_TRANSFER
     ...
     */
    //#define SDCARD_CONNECTION LCD  <- default example
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE 60             // (mm/s) Default feedrate for retracting  # current S3D: 3300 m/min -> 55 mm/s -> was 45
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      940 // 0.798 A - 1.197 A Hemera
    #define E0_MICROSTEPS    16
